...
flags.DEFINE_integer('epochs', 2000, 'Number of epochs for training.')
...
logging.basicConfig(stream=sys.stdout, level=logging.INFO,
    format=log_format, datefmt='%m/%d %I:%M:%S', filemode="w")
...
# Load data
adj, num_ent, train, test, valid = load_data_align(FLAGS)
...
model = model_func(placeholders, input_dim, hidden_dim, output_dim, dataset=FLAGS.dataset,
                    ...
                    logging=True, rel_update=FLAGS.rel_update, task="align", names_neg=names_neg)
